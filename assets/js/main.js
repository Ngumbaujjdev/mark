...
const sendEmail = (e) => {
  ...
  if (
    ...
    // show message
    contactMessage.textContent = "Please Fill all Inputs";
  } else {
    ...
    emailjs
      ...
      .then(
        () => {
          ...
          contactMessage.textContent = "Message Sent Succesifully";
        ...
        (error) => {
          (contactMessage.textContent = "something went wrong"), error;
        }
      );
    // to clear all form inputs after the form is  submited
    contactName.value = "";
    contactEmail.value = "";
    contactProject.value = "";
  }
